...
// GM view is half shaded when fogExploration is enabled.
    newClass = patchClass(SightLayer, SightLayer.prototype.draw, 9,
      ...
      `this.alphas.unexplored = game.user.isGM ? ( this.fogExploration ? 0.5 : 0.0 ) : 1.0;`);
    if (!newClass) return;
